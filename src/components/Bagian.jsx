...
//   return (
//     <section
//       style={{ height: `50rem`, maxWidth: `100vh` }}
//       className="portfolio py-2 faq"
//       id="portfolio"
//     >
//       <h1 className="fs-2">BAGIAN - BAGIAN ENDOSKOP</h1>
//       <style>
//         {`
//         .carousel-inner {
//           height:100%
...
//               interval={null}
//               className="faq w-full py-5 h-100 "
//             >
//               {listBagian.map((bagian, index) => (
            ...
            >
              {listBagian.map((bagian, index) => (
                ...
                >
                  ...
                  <Image fluid className="img-fluid mh-100" src={bagian.img} />
                  <Carousel.Caption className="text-start">
                    <h3>{bagian.name}</h3>
                    <p>{bagian.description}</p>
                  </Carousel.Caption>
